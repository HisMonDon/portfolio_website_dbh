...
describe('applyAvatarVisualTreatment', () => {
  it('ports the physical reflections, skin shader, lip gloss, surface tuning, and temple HUD', () => {
    ...
    expect(headMaterials[0].clearcoat).toBe(0.18)
    expect(headMaterials[0].roughness).toBe(0.6)
    ...
    expect(bodyMaterial.clearcoat).toBe(0.18)
    expect(bodyMaterial.clearcoatRoughness).toBe(0.45)
